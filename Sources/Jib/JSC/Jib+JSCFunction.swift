...
public typealias JibJSCFunctionBody = ([Hitch]) -> JibUnknown?
...
class JibBody {
    @usableFromInline
    var block: JibJSCFunctionBody?
    
    @usableFromInline
    init(_ block: @escaping JibJSCFunctionBody) {
        self.block = block
    }

    @inlinable
    func set(_ block: @escaping JibJSCFunctionBody) {
        self.block = block
    }
...
public class JibJSCFunction: JibFunction {
    @usableFromInline
    ...
    @usableFromInline
    init?(jib: Jib, name: HalfHitch, body: @escaping JibJSCFunctionBody) {
        self.jib = jib
